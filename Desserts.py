...
def Insert_item(name,QTY,TOTAL):
    ...
    recordTuple = (RandomNumber,"DE",formatted_date,name,QTY,TOTAL)
...
def Desserts():
    ...
    frame1 = Frame(root1)
    frame1.pack()
    welcome_text = Label(root1,text="DESSERTS",fg="white", bg="black",font='Calibri 18 bold ')
    welcome_text.pack()
    welcome_text.place(x=1550,y=10)
    
    L1 = Label(root1, text="cannoli")
    L1.pack()
    L1.place(x=10,y=200)
    ...
    L2 = Label(root1, text="cheesecake")
    L2.pack()
    L2.place(x=10,y=400)
    ...
    L3= Label(root1, text="panna cotta")
    L3.pack()
    ...
    L5 = Label(root1, text="special sundae")
    L5.pack()
    ...
    L6 = Label(root1, text="zabiglione")
    L6.pack()
    ...
    def getent():
        ...
        if c== 0:
            ...
            Insert_item("panna cotta",c,c*98)
            food.append(c*98)
            z="           "
            x=c*98
            y="panna cotta"
        ...
        if e== 0:
            ...
            Insert_item("Special sundae",e,e*130)
            food.append(e*130)
            z="    "
            x=e*130
            y="Special sundae"
        ...
        if f== 0:
            ...
            Insert_item("zabiglione",f,f*150)
            food.append(f*150)
            z="           "
            x=f*150
            y="zabiglione"
