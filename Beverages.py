...
def Insert_item(name,QTY,TOTAL):
    ...
    recordTuple = (RandomNumber,"BE",formatted_date,name,QTY,TOTAL)
...
def Beverages():
    ...
    frame1 = Frame(root1)
    frame1.pack()
    welcome_text = Label(root1,text="BEVERAGES",fg="white", bg="black",font='Calibri 18 bold ')
    welcome_text.pack()
    welcome_text.place(x=550,y=10)
    
    L1 = Label(root1, text="Ginger Tea")
    L1.pack()
    L1.place(x=10,y=200)
    ...
    L2 = Label(root1, text="Aguas frescas")
    L2.pack()
    L2.place(x=10,y=400)
    ...
    L3= Label(root1, text="Aguapanela")
    L3.pack()
    ...
    def getent():
        ...
        if b== 0:
            ...
            Insert_item("Aguas frescas",b,b*25)
            food.append(b*25)
            z="       "
            x=b*25
            y="Aguas frescas"
