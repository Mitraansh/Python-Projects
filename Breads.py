...
def Insert_item(name,QTY,TOTAL):
    ...
    recordTuple = (RandomNumber,"B",formatted_date,name,QTY,TOTAL)
...
def Breads():
    ...
    frame1 = Frame(root1)
    frame1.pack()
    welcome_text = Label(root1,text="BREADS",fg="white", bg="black",font='Calibri 18 bold ')
    welcome_text.pack()
    welcome_text.place(x=1550,y=10)
    
    L1 = Label(root1, text="Matzo Bread")
    L1.pack()
    L1.place(x=10,y=200)
    ...
    L2 = Label(root1, text="Pita Bread")
    L2.pack()
    L2.place(x=10,y=400)
    entry2 = Entry(root1, bd =5)
    entry2.insert(END, '0')
    entry2.pack()
    entry2.place(x=110,y=400)
      
    L3= Label(root1, text="Baguette Bread")
    L3.pack()
    L3.place(x=500,y=200)
    entry3 = Entry(root1, bd =5)
    entry3.insert(END, '0')
    entry3.pack()
    entry3.place(x=600,y=200)

    L4 = Label(root1, text="Rye Bread")
    L4.pack()
    ...
    L5 = Label(root1, text="Multigrain Bread")
    L5.pack()
    L5.place(x=1000,y=200)
    entry5 = Entry(root1, bd =5)
    entry5.insert(END, '0')
    entry5.pack()
    entry5.place(x=1100,y=200)
       
    L6 = Label(root1, text="Ciabatta Bread")
    L6.pack()
    L6.place(x=1000,y=400)
    entry6 = Entry(root1, bd =5)
    entry6.insert(END, '0')
    entry6.pack()
    entry6.place(x=1100,y=400)
    ...
    def getent():
        ...
        if a== 0:
            ...
            Insert_item("Matzo Bread",a,a*32)
            food.append(a*32)
            z="           "
            x=a*32
            y="Matzo Bread"
        ...
        if c== 0:
            ...
            Insert_item("Baguette Bread",c,c*32)
            food.append(c*32)
            z="       "
            x=c*32
            y="Baguette Bread"
        ...
        if e== 0:
            ...
            Insert_item("Multigrain Bread",e,e*25)
            food.append(e*25)
            z="     "
            x=e*25
            y="Multigrain Bread"
        ...
        if f== 0:
            ...
            Insert_item("Ciabatta Bread",f,f*21)
            food.append(f*21)
            z="         "
            x=f*21
            y="Ciabatta Bread"
